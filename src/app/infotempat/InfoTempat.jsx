  ...
  return (
    <>
      <main>
        ...
        <section className="relative w-screen h-[500px] flex flex-col px-8 items-center justify-center">
          <Image
          ...
          >
            ...
            <p className="text-white text-text-m md:text-text-l text-center">
              Fort Rotterdam, sebuah mercusuar sejarah di tengah kota Makassar,
              membawa kita pada perjalanan melintasi lorong waktu kolonial yang
              kaya.
            </p>
          </div>
        </section>
                ...
                <BoxInformasi key={people.id}>
                  <li className="list-none h-full text-center justify-center px-3 flex flex-col items-center">
                    ...
                    <div className="items-center justify-center py-6 gap-3 flex flex-col">
                      <p className="font-semibold">{people.text}</p>
                      <p>{people.desc}</p>
                    </div>
                  </li>
                </BoxInformasi>
